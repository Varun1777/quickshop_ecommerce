        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center md:justify-end relative">
            <div className="relative">
              ...
              {/* Product badges */}
              <div className="absolute -top-4 -right-4 bg-red-500 text-white font-bold px-4 py-2 rounded-full transform rotate-12 shadow-lg">
                70% OFF
              </div>
              ...
              {/* Timer */}
              <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 bg-white text-gray-900 font-bold px-4 py-2 rounded-md shadow-lg flex items-center space-x-1">
